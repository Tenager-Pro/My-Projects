...
#pragma endregion
	private: System::Void Main_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		this->label6->Text = Convert::ToString(num);//изменение label
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (check() != 0) {
			...
			MessageBox::Show("Нет прав", "EROR", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
